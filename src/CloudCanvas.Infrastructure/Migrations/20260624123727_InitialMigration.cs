        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProPicUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GalleryId1 = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Photos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Photos_Galleries_GalleryId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PhotoThumbnails_Photos_PhotoId",
                        column: x => x.PhotoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Galleries_ApplicationUserId1",
                table: "Galleries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Photos_GalleryId1",
                table: "Photos",
                column: "GalleryId1");

            migrationBuilder.CreateIndex(
                name: "IX_PhotoThumbnails_PhotoId",
